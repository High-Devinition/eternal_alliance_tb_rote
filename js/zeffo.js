	...
	data: function () {
		...
		missions: [{
			...
			territoryPoints: [
				...
				recommendedSquads: [24],//jkck
				enemyWaves: [34],
				modifiers: [2,3,6],
            reqs: [19],
			}, 
			{id: 30, name: 'OP', type: 'zeffo', position: 'right',preqs:["Characters: Relic 7","Ships: 7⭐"], platoonAbility: [0], platzones: [0]}
			],
