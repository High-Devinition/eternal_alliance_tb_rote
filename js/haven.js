...
Vue.component('mission', {
	data: function () {
		...
		missions: [{
			...
			{id: 30, name: 'OP', type: 'haven', position: 'right', preqs:["Characters: Relic 8","Ships: 7⭐"], platoonAbility: [0], platzones: [0, 1, 2]}
			],
