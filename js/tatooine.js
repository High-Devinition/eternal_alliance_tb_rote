...
Vue.component('mission', {
	data: function () {
		...
		missions: [{
            ...
            recommendedSquads: [77,78],//fennec
			enemyWaves: [50,51],
            reqs: [18],
            modifiers: [3],
			},
			...
			territoryPoints: [
				...
				recommendedSquads: [35,80,81,79],//gen
				enemyWaves: [48,49],
				modifiers: [3],
            reqs: [21],
			}, 
			...
			{id: 30, name: 'OP', type: 'tatooine', position: 'right', preqs:["Characters: Relic 7","Ships: 7⭐"], platoonAbility: [0], platzones: [0, 1, 2]}
			],
