...
Vue.component('mission', {
	data: function () {
		...
		missions: [{
			...
			recommendedSquads: [82,87,84,83],//tr
			enemyWaves: [46,48],
			modifiers: [3],
            reqs: [20],
            notes: [3]
			...
			territoryPoints: [
				...
				recommendedSquads: [82,87,84,83],//tl
				enemyWaves: [46,48],
				modifiers: [3],
				notes: [3],
            reqs: [20],
			...
			{id: 30, name: 'OP', type: 'kessel', position: 'right', preqs:["Characters: Relic 8","Ships: 7⭐"], platoonAbility: [0], platzones: [0,1,2]}
			],
