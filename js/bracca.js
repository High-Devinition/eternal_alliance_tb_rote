	...
	data: function () {
		return {
			...
			enemies: [
				...
				'Hound\'s Tooth',//16
				//17
				'Wave 1: Wat Tambor (L), Nute Gunray, Poggle the Lesser',//18
				'Wave 2: Jedi Master Kenobi',//19
				'Wave 1: Command Battle Droid (L), 2x Magnaguard, B2, B1, Droideka',//20
				"Wave 2: Nute Gunray (L), 2x Magnaguard, 2x B2, Security Battle Droid",//20
				"Wave 2: Wat Tambor (L), 2x Magnaguard, 2x B2, Security Battle Droid",//21
				"Wave 2: Geonosian Brood Alpha (L), Geo Spy, Geo Soldier, Poggle, Sun Fac",//22
				"Malevolence, Hyena Bomber, Vulture Droid, Geo Starfighter",//23
				"Malevolence, Sun Fac's Starfigher, Geo Spy's Starfighter, Geo Starfighter",//24
				"Wave 1: Geonosian Brood Alpha (L), Geo Spy, Geo Soldier, Poggle, Sun Fac",//25
				"Wave 2: Nexu",//26
				"Wave 1: Geonosian Brood Alpha, Geonosian Soldier, Reek",//27
				"Wave 1: Acklay",//28
				"Wave 1: 3x Partisan Fighter, 2x Rebel Spy",//29
				"Wave 2: Kanan Jarrus (L), Ezra Bridger, Chopper, Rex, Partisan Fighter",//30
				"Wave 1: Stormtrooper Commander (L), Stormtrooper, Tie Pilot, Recon Trooper, Scout Trooper",//31
				"Wave 2: Imperial Officer (L), Stormtrooper Commander, Stormtrooper, Tie Pilot, Recon Trooper, Scout Trooper",//32
				"Executrix, Tie Advanced X1, Tie Bomber, Tie Fighter, Tie Interceptor (R)",//33
				"Unknown",//34
				"Wave 2: General Veers (L), Colonel Starck, Stormtrooper Commander, 2x Stormtrooper, Tie Pilot",//35
				"Wave 1: Mob Enforcer (L), Cartel Spy, 2x Cartel Bruiser, Cartel Saboteur",//36
				"Wave 2: Qi'ra (L), Young Han, Cartel Bruiser, Cartel Spy, Cartel Saboteur ",//37
				"Chimaera, Tie Advanced X1, Scythe, Tie Fighter, Tie Interceptor (R)",//38
				...
				"Wave 1: 2x Purge Trooper",//43
				"Wave 2: Second Sister (L), Purge Trooper"//44
			],
			platoons: [
			...
			{ id: 30, name: 'm2', type: 'bracca', position: 'right', preqs: ["Characters: Relic 6","Ships: 7⭐"], platoonAbility: [0], platzones: [0, 1 ,2]}
			],
