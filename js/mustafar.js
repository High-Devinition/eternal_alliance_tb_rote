		...
		//---------------------------------------------------------------------------------------------------------------------------------DS SQUADS
			...
			enemySquads: [

				{
					id: 0,
					name: 'DMus-1-W1',
					toons: ['wat_tambor', 'nute_gunray', 'poggle_the_lesser']
				},
				{
					id: 1,
					name: 'DMus-1-W2',
...
$(document).ready(function () {
	...
	$("img").click(function () {
		...
		//$('.toonImage').each(function () {
		//	$(this).addClass('toonImage' + i);
		//	i++;
		//});

	});
////Finnicky function for handling classes of toons that are leaders; but it works LOL
//	$(".mission").click(function () {
//			i--;
//		$('.toonImage').each(function () {
//			$(this).removeClass('toonImage');
//			$(this).removeClass('toonImage' + i);
//			$(this).addClass('toonImage' + i);
//			i++;
//		});
...
//if (document.querySelector('.toonImage') !== null) {
//	$('.toonImage').each(function () {
//		$('toonImage').addClass('toonImage' + i);
//		i++;
//	});
//	// .. it exists
//}
